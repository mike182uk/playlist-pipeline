...
describe('execute', () => {
  describe('returns an array of filtered tracks based on the filter provided in the config', () => {
    ...
    test('filters track number equals', async () => {
      const filteredTracks = await execute({
        config: {
          tracks: trackCollectionName,
          filter: {
    ...
    test('filters track number not equals', async () => {
      const filteredTracks = await execute({
        config: {
          tracks: trackCollectionName,
          filter: {
    ...
    test('filters track number greater than', async () => {
      const filteredTracks = await execute({
        config: {
          tracks: trackCollectionName,
          filter: {
    ...
    test('filters track number greater than or equal to', async () => {
      const filteredTracks = await execute({
        config: {
          tracks: trackCollectionName,
          filter: {
    ...
    test('filters track number less than', async () => {
      const filteredTracks = await execute({
        config: {
          tracks: trackCollectionName,
          filter: {
    ...
    test('filters track number less than or equal to', async () => {
      const filteredTracks = await execute({
        config: {
          tracks: trackCollectionName,
          filter: {
    ...
    test('filters popularity equals', async () => {
      const filteredTracks = await execute({
        config: {
          tracks: trackCollectionName,
          filter: {
    ...
    test('filters popularity not equals', async () => {
      const filteredTracks = await execute({
        config: {
          tracks: trackCollectionName,
          filter: {
    ...
    test('filters popularity greater than', async () => {
      const filteredTracks = await execute({
        config: {
          tracks: trackCollectionName,
          filter: {
    ...
    test('filters popularity greater than or equal to', async () => {
      const filteredTracks = await execute({
        config: {
          tracks: trackCollectionName,
          filter: {
    ...
    test('filters popularity less than', async () => {
      const filteredTracks = await execute({
        config: {
          tracks: trackCollectionName,
          filter: {
    ...
    test('filters popularity less than or equal to', async () => {
      const filteredTracks = await execute({
        config: {
          tracks: trackCollectionName,
          filter: {
    ...
    test('filters duration equals', async () => {
      const filteredTracks = await execute({
        config: {
          tracks: trackCollectionName,
          filter: {
    ...
    test('filters duration not equals', async () => {
      const filteredTracks = await execute({
        config: {
          tracks: trackCollectionName,
          filter: {
    ...
    test('filters duration greater than', async () => {
      const filteredTracks = await execute({
        config: {
          tracks: trackCollectionName,
          filter: {
    ...
    test('filters duration greater than or equal to', async () => {
      const filteredTracks = await execute({
        config: {
          tracks: trackCollectionName,
          filter: {
    ...
    test('filters duration less than', async () => {
      const filteredTracks = await execute({
        config: {
          tracks: trackCollectionName,
          filter: {
    ...
    test('filters duration less than or equal to', async () => {
      const filteredTracks = await execute({
        config: {
          tracks: trackCollectionName,
          filter: {
