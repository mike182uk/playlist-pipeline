import AuthenticationRequest from "spotify-web-api-node/src/authentication-request.js"
...
export function getAccessToken(
  { redirectUri, clientId, code, codeVerifier },
  callback
) {
  return AuthenticationRequest.builder()
    .withPath("/api/token")
 ...
 */
export function getRefreshedAccessToken({ refreshToken, clientId }, callback) {
  return AuthenticationRequest.builder()
    .withPath("/api/token")
    .withBodyParameters({
