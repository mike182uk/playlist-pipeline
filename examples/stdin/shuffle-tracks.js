...
const config = {
  ...
  tasks: {
    get_tracks: {
      ...
      spotify_url:
        "https://open.spotify.com/album/6d2dI1NyZB5xHpqBLPiHbP?si=mod36-DmSp6Bzg0ctu66q", // Album - AVA - I-Empire
    },
    shuffle_tracks: {
      type: "tracks.shuffle",
      tracks: "get_tracks",
    ...
    save_tracks: {
      ...
      spotify_url:
        "https://open.spotify.com/playlist/70yOX4JIqkUL3optIQmicc?si=eade5d89aa7349a4", // Dev playlist - Save
