...
import { Track, TrackCollection } from "../track"
...
export default class FilterTracksTask
  implements TrackCollectionModifierTask<FilterTracksTaskConfig>
{
  ...
  public async execute({
    config,
    trackCollections,
  }: ExecuteTaskOptions<FilterTracksTaskConfig>): Promise<TrackCollection> {
