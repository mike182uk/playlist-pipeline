...
describe("execute", () => {
  describe("returns a filtered track collection based on the filter provided in the config", () => {
    ...
    test("filters by album equals", async () => {
      ...
      expect(filteredTracks).toEqual([tracks[3]])
    })
    ...
    test("filters by artist equals", async () => {
      ...
      expect(filteredTracks).toEqual([tracks[0], tracks[1]])
    })
    ...
    test("filters by name equals", async () => {
      ...
      expect(filteredTracks).toEqual([tracks[1]])
    })
    ...
    test("filters by track number equals", async () => {
      ...
      expect(filteredTracks).toEqual([tracks[0], tracks[2], tracks[4]])
    })
    ...
    test("filters by genre equals", async () => {
      ...
      expect(filteredTracks).toEqual([tracks[4], tracks[5], tracks[6]])
    })
    ...
    test("filters by explicit equals", async () => {
      ...
      expect(filteredTracks).toEqual([tracks[3], tracks[6]])
    })
    ...
    test("filters by popularity equals", async () => {
      ...
      expect(filteredTracks).toEqual([tracks[6]])
    })
    ...
    test("filters by popularity greater than", async () => {
      ...
      expect(filteredTracks).toEqual([tracks[1], tracks[4], tracks[6]])
    })
    ...
    test("filters by popularity less than", async () => {
      ...
      expect(filteredTracks).toEqual([tracks[2], tracks[3], tracks[5]])
    })
    ...
    test("filters by duration equals", async () => {
      ...
      expect(filteredTracks).toEqual([tracks[0]])
    })
    ...
    test("filters by duration greater than", async () => {
      ...
      expect(filteredTracks).toEqual([tracks[2], tracks[4]])
    })
    ...
    test("filters by duration less than", async () => {
      ...
      expect(filteredTracks).toEqual([tracks[1], tracks[3]])
    })
    ...
    test("filters by duration less than or equal to", async () => {
      ...
      expect(filteredTracks).toEqual([tracks[1], tracks[3], tracks[6]])
    })
    ...
    test("filters by releaseYear less than", async () => {
      ...
      expect(filteredTracks).toEqual([tracks[0], tracks[2]])
    })
    ...
    test("filters by releaseYear less than or equal to", async () => {
      ...
      expect(filteredTracks).toEqual([tracks[0], tracks[1], tracks[2]])
    })
    ...
    test("filters by multiple fields (AND)", async () => {
      ...
      expect(filteredTracks).toEqual([tracks[2]])
    })
    ...
    test("filters by multiple field conditions (AND)", async () => {
      ...
      expect(filteredTracks).toEqual([tracks[3], tracks[4], tracks[5]])
    })
    ...
    test("filters by multiple filters (OR)", async () => {
      ...
      expect(filteredTracks).toEqual([tracks[1], tracks[2], tracks[3]])
    })
